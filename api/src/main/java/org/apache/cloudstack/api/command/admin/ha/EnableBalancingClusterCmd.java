...
@APICommand(name = EnableBalancingClusterCmd.APINAME, description = "Enables Balancing cluster-wide",
        responseObject = SuccessResponse.class,
        requestHasSensitiveInfo = false, responseHasSensitiveInfo = false,
        since = "4.11", authorized = {RoleType.Admin})
public final class EnableBalancingClusterCmd extends BaseAsyncCmd {
    public static final String APINAME = "enableBalancingCluster";
    ...
    public void execute() throws ResourceUnavailableException, InsufficientCapacityException, ServerApiException, ConcurrentOperationException, ResourceAllocationException, NetworkRuleConflictException {
        ...
        final boolean result = haConfigManager.enableBalancing(cluster);
