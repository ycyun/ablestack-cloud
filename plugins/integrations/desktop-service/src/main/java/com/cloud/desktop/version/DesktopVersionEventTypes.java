...
public class DesktopVersionEventTypes {
    ...
    public static final String EVENT_DESKTOP_MASTER_VERSION_ADD = "DESKTOP.MASTER.VERSION.ADD";
    public static final String EVENT_DESKTOP_MASTER_VERSION_DELETE = "DESKTOP.MASTER.VERSION.DELETE";
    public static final String EVENT_DESKTOP_MASTER_VERSION_UPDATE = "DESKTOP.MASTER.VERSION.UPDATE";
}
