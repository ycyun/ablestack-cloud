...
@APICommand(name = AddResourceRequestCmd.APINAME,
        description = "Add a Resource Request",
...
public class AddResourceRequestCmd extends BaseCmd implements UserCmd {
    ...
    public void execute() throws ServerApiException, ConcurrentOperationException {
        try {
            ResourceRequestResponse response = resourceRequestService.addResourceRequest(this);
            if (response == null) {
