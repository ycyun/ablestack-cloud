...
@APICommand(name = AddBoardFilesCmd.APINAME,
...
public class AddBoardFilesCmd extends BaseCmd implements UserCmd {
    public static final Logger LOGGER = Logger.getLogger(AddBoardFilesCmd.class.getName());
    public static final String APINAME = "addBoardFiles";
    ...
    //////////////// API parameters /////////////////////
    /////////////////////////////////////////////////////
    @Parameter(name = ApiConstants.FILES, type = CommandType.STRING,
    ...
    public void execute() throws ServerApiException, ConcurrentOperationException {
        try {
            BoardResponse response = boardService.addBoardFiles(this);
            if (response == null) {
